from src.networks.gp_transition import GPDynamics
...
from src.utils import angular_transform
...
class GPUnscentedKalmanVariationalAutoencoder(UnscentedKalmanVariationalAutoencoder):

    def __init__(self, config, load_name=None):
        super(GPUnscentedKalmanVariationalAutoencoder, self).__init__(config, load_name)
